...
<head>
	...
	<link href="foto/awal.jpg" rel="icon" type="images/x-icon">
...
<body>
				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="foto/awal.jpg" alt="logo-dkm" width="70" />
						</td>
	...
	<section id="body-of-report">
		<div class="container-fluid">
			<h4 class="text-center">Laporan Data Jajanan Masuk Periode Tanggal <?php echo format_tanggal($mulai);?> s/d <?php echo format_tanggal($selesai);?></h4>
			<br />
