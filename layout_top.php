            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						?>
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-th-large fa-fw"></i>&nbsp;Data Jajanan dan Minuman<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									...
									if($pagedesc == "Data Barang") {
										echo '<li><a href="barang.php" class="active">Data Jajanan</a></li>';
									}
									else {
										echo '<li><a href="barang.php">Data Jajanan</a></li>';
									}
									if($pagedesc == "Data Jasa") {
										echo '<li><a href="jasa.php" class="active">Data Minuman</a></li>';
									}
									else {
										echo '<li><a href="jasa.php">Data Minuman</a></li>';
									}
								?>
							</ul><!-- /.nav-second-level -->
						<?php
